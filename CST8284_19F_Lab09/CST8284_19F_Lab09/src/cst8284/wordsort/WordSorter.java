...
public class WordSorter extends JFrame {
	...
	private static void loadAndShowWords() {
		...
		/*
		 * Uncomment the following code when you have finished TODO #1 and test your
		 * code. Make sure the word list appears in the scroll pane. Then remove this
		 * comment.
		 */
	...
	public static JPanel getWestPanel() {
		...
		/*
		 * Uncomment this section when you are ready to display the file information in
		 * the left panel of the swing GUI as per TODO #2. Be sure to remove this
		 * comment.
		 * 
		 */
